...
import com.commercetools.api.models.staged_quote.*;
...
public class Task10a_CreateQuote {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Logger logger = LoggerFactory.getLogger(Task10a_CreateQuote.class.getName());
